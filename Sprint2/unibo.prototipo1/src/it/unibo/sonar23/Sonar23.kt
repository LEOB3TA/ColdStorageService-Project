		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t031",targetState="work",cond=whenDispatch("sonaractivate"))
				}	 
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t032",targetState="handlesonardata",cond=whenEvent("sonardata"))
				}	 
