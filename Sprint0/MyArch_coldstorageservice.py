...
with Diagram('coldstorageserviceArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  ...
  with Cluster('env'):
     ...
     with Cluster('ctxmanager', graph_attr=nodeattr):
     ...
     coldstorageservice >> Edge(color='blue', style='solid', xlabel='updategui', fontcolor='blue') >> servicestatusgui
     transporttrolley >> Edge(color='forestgreen', style='dashed', xlabel='chargetaken', fontcolor='forestgreen') >> coldstorageservice
     ...
     basicrobot >> Edge(color='forestgreen', style='dashed', xlabel='doplandone/doplanfailed', fontcolor='forestgreen') >> transporttrolley
     transporttrolley >> Edge(color='magenta', style='solid', xlabel='step', fontcolor='magenta') >> basicrobot
     basicrobot >> Edge(color='forestgreen', style='dashed', xlabel='stepdone/stepfail', fontcolor='forestgreen') >>  transporttrolley
     transporttrolley >> Edge(color='blue', style='solid', xlabel='updategui', fontcolor='blue') >> servicestatusgui
