...
//            }
        ...
        companion object{
            ...
            fun fromJsonString(str : String) : resources.ColdStorageService_new {
                return gson.fromJson(str, resources.ColdStorageService_new::class.java)
            }
        }
       ...
       /* fun fromJson(json: String): resources.ColdStorageService {
