		...
		return { //this:ActionBasciFsm
				state("init") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t012",targetState="idle",cond=whenReply("engagedone"))
					transition(edgeName="t013",targetState="waitforfree",cond=whenReply("engagerefused"))
				}	 
				...
				state("waitforfree") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t014",targetState="idle",cond=whenTimeout("local_tout_transporttrolley_waitforfree"))   
				}	 
				state("idle") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t015",targetState="moverobottoindoor",cond=whenRequest("pickup"))
				}	 
				state("moverobottoindoor") { //this:State
					...
					transition(edgeName="t017",targetState="movetoport",cond=whenReply("moverobotdone"))
				}	 
				...
				state("goahead") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t023",targetState="movetoport",cond=whenDispatch("gotomovetoport"))
					transition(edgeName="t024",targetState="depositactionended",cond=whenDispatch("gotodepositactionended"))
					transition(edgeName="t025",targetState="corrDir",cond=whenDispatch("gotorobottohome"))
				}	 
				state("movetoport") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t026",targetState="handlerobotstopped",cond=whenEvent("stop"))
				...
				state("depositactionended") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t028",targetState="robottohome",cond=whenTimeout("local_tout_transporttrolley_depositactionended"))   
					transition(edgeName="t029",targetState="moverobottoindoor",cond=whenRequest("pickup"))
				}	 
				state("robottohome") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="corrDir",cond=whenReply("moverobotdone"))
