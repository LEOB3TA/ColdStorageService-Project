		...
		return { //this:ActionBasciFsm
				state("init") { //this:State
					action { //it:State
						...
						CoapObserverSupport(myself, "localhost","8099","ctxprototipo4","transporttrolley")
				...
				state("idle") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t03",targetState="updatestorage",cond=whenDispatch("updateS"))
					transition(edgeName="t04",targetState="updaterejected",cond=whenDispatch("updateR"))
					transition(edgeName="t05",targetState="updateposition",cond=whenDispatch("coapUpdate"))
					transition(edgeName="t06",targetState="updategui",cond=whenDispatch("getData"))
				}	 
